...
class Customer:
    ...
    @staticmethod
    def get_cust_by_username(u_name: str):
...
if __name__ == '__main__':
    print(Customer.get_cust_by_username('snehalmankar'))
    print(type(Customer.get_cust_by_username('snehalmankar')))

    print(Customer.get_cust_by_username('snehal'))
    print(type(Customer.get_cust_by_username('snehal')))
